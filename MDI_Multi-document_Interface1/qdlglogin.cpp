...
{   //读取存储的用户名和密码, 密码是经过加密的
    ...
    QString appName="MDI_Multi-document_Interface"; //HKEY_CURRENT_USER/Software/WWB-Qt/MDI_Multi-document_Interface
...
{   //保存用户名，密码等设置
    QSettings settings("WWB-Qt","MDI_Multi-document_Interface"); //注册表键组
